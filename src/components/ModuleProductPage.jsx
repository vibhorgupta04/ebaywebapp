    ...
    <div className="mx-2 my-10">
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex flex-col mx-6">
          ...
          <div className="border-b-2 h-fit py-4">
            ...
            <br />
            <p className="text-sm font-medium text-gray-500">or Best Offer</p>
            <p className="pt-4">
              US ${Math.floor(Math.random() * 10).toFixed(2)} eBay International
              Shipping
            </p>
          </div>
      ...
      <div className="my-8 ring-1 ring-gray-200 px-4 py-10 rounded flex flex-col gap-4 ">
        ...
        <div className="text-gray-400">
          Last updated on Feb 13, 2024 15:12:19 PST
        </div>
        <div>
